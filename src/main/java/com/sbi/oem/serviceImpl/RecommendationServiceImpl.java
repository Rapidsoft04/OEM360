...
public class RecommendationServiceImpl implements RecommendationService {
	...
	@Override
	public Response<?> viewRecommendationDetailsForOemAndAgmAndGmPagination(SearchDto searchDto ,long pageNumber, long pageSize) {
			...
			if (master != null && master.isPresent()) {
				...
				if (master.get().getUserTypeId().name().equals(UserType.OEM_SI.name())) {
					...
					Long OemId = master.get().getUserId().getId();
					 ...
					 Page<Recommendation> recommendationPage = recommendationRepository.findAllRecommendationsOemAndAgmPagination(OemId,
			...
			if (master != null && master.isPresent()) {
				...
				if (master.get().getUserTypeId().name().equals(UserType.OEM_SI.name())) {
					...
					Long OemId = master.get().getUserId().getId();
					 ...
					 List<Recommendation> RecomendationListOem = recommendationRepository.findAllRecommendationsOemAndAgmBySearchDto(OemId,
							searchDto);
